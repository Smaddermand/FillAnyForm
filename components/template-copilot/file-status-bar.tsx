...
type TemplateStatus = Doc<"templates">["status"];
  ...
  return (
    <div className="h-14 border-b border-border bg-card px-4 flex items-center justify-between shrink-0">
      ...
      <div className="flex items-center gap-3 min-w-0">
        {/* PowerPoint icon */}
        <div className="w-10 h-10 rounded-lg bg-[#D24726]/10 flex items-center justify-center shrink-0">
          <svg viewBox="0 0 24 24" className="w-6 h-6 text-[#D24726]">
            ...
            <text x="7" y="17" fontSize="7" fontWeight="bold" fill="white">
              P
            </text>
          </svg>
        </div>
        ...
        <button className="flex items-center gap-1.5 hover:bg-muted rounded-md px-2 py-1 -ml-1 transition-colors min-w-0">
