...
type FieldIconType = "folder" | "user" | "chart" | "alert" | "check";

function fieldTypeToIconType(
...
interface SlideCanvasProps {
  fields: Doc<"fields">[];
  activeFieldId: Id<"fields"> | null;
  onFieldSelect: (id: Id<"fields">) => void;
  slideNumber: number;
  totalSlides: number;
}
            ...
            <div className="aspect-video relative">
              ...
              <div className="absolute top-0 left-0 right-0 h-[18%] bg-primary flex items-center px-6 gap-3">
                ...
                <div className="absolute top-0 right-0 w-[60%] h-full overflow-hidden">
                  ...
                  >
                    <polygon
                      points="100,0 400,0 400,100 200,100"
                      fill="rgba(255,255,255,0.1)"
                    />
                    <polygon
                      points="150,0 400,0 400,100 250,100"
                  ...
                  <div className="mt-6 flex flex-col gap-2">
                    {fields.length === 0 ? (
                      ...
                      fields.map((field) => {
                        ...
                        const iconType = fieldTypeToIconType(field.type);
                        return (
                          <button
                            key={field._id}
                            type="button"
      ...
      <div className="h-12 border-t border-border bg-card px-4 flex items-center justify-between shrink-0">
        ...
        <div className="flex items-center gap-2">
          ...
          <span className="text-sm text-muted-foreground">
            {totalSlides > 0 ? (
              <>
                <span className="font-medium text-foreground">{slideNumber}</span>
                {" "}/ {totalSlides}
              </>
            ) : (
